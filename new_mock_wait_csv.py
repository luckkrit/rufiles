...
with open(excel_wait_filename, "a") as f:
    f.write(
        "academic_year,academic_semester,student_code,student_name_th,student_name_en,testing_information_code,register_subject_code\n"
    )
